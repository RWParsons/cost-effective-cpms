...
if (do_new_analyses | !file.exists("output/calibration_experiment/calibration_simulations-falls.rds")) {
  ...
  f_do_sim_calibration_falls <- function(intercept_adjustment) {
    do_simulation(
  ...
  x_calibrated <- f_do_sim_calibration_falls(0)
  x_adjusted_up <- f_do_sim_calibration_falls(1)
  x_adjusted_down <- f_do_sim_calibration_falls(-1)
  x_adjusted_up2 <- f_do_sim_calibration_falls(2)
  x_adjusted_down2 <- f_do_sim_calibration_falls(-2)
...
if (do_new_analyses | !file.exists("output/calibration_experiment/calibration_simulations-icu.rds")) {
  ...
  f_do_sim_calibration_icu <- function(intercept_adjustment) {
    do_simulation(
  ...
  x_calibrated <- f_do_sim_calibration_icu(0)
  x_adjusted_up <- f_do_sim_calibration_icu(1)
  x_adjusted_down <- f_do_sim_calibration_icu(-1)
  x_adjusted_up2 <- f_do_sim_calibration_icu(2)
  x_adjusted_down2 <- f_do_sim_calibration_icu(-2)
...
inb_cowplot_falls <- cowplot::plot_grid(plotlist = inb_plots_falls, ncol = 1, rel_heights = c(0.375, rep(0.3, length(inb_plots_falls) - 1)))


# cowplot::plot_grid(plotlist=calibration_plots, ncol=1)

calibration_cowplot_falls <- plot_grid(
  plotlist = c(list(NULL), calibration_plots_falls),
  ncol = 1,
...
combined_fig_falls <- plot_grid(inb_cowplot_falls, calibration_cowplot_falls, ncol = 2, rel_widths = c(0.4, 0.25))

if (save_plots) {
  ggsave(filename = "output/calibration_experiment/calibration_plots-falls.jpeg", plot = combined_fig_falls, dpi = 600, height = 8, width = 6)
}
...
inb_cowplot_icu <- cowplot::plot_grid(plotlist = inb_plots_icu, ncol = 1, rel_heights = c(0.375, rep(0.3, length(inb_plots_icu) - 1)))



calibration_cowplot_icu <- plot_grid(
  plotlist = c(list(NULL), calibration_plots_icu),
  ncol = 1,
  rel_heights = c(0.075, rep(0.3, length(calibration_plots_icu)))
)

combined_fig_icu <- plot_grid(inb_cowplot_icu, calibration_cowplot_icu, ncol = 2, rel_widths = c(0.4, 0.25))
combined_fig_icu
if (save_plots) {
  ggsave(filename = "output/calibration_experiment/calibration_plots-icu.jpeg", plot = combined_fig_icu, dpi = 600, height = 8, width = 6)
}

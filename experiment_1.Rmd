...
# save INB plots
cowplot::plot_grid(
  plotlist=get_plot_list(ll_falls, cols_rename, get_what="inb", inb_ref_col="treat_all"), 
  ncol=length(unique(g_falls$sim_auc))
)
ggsave(filename="output/falls_simulations_inb.jpeg", height=24, width=12)

cowplot::plot_grid(
  plotlist=get_plot_list(ll_icu, cols_rename, get_what="inb", inb_ref_col="treat_none"), 

...
ggsave(filename="output/calibration_plots.jpeg", plot=combined_fig, dpi=600, height=10.5, width=14)
...
ggsave(filename="output/falls_simulations_inb.jpeg", height=24, width=12)

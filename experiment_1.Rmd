...
event_rate_plot <- cowplot::plot_grid(
  plotlist=get_plot_list(ll_event_rate, cols_rename, get_what="nmb", remove_axis=T, label_wrap_width=20) %>% keep_only_first_plot_strip(), 
  ncol=1,
...
auc_plot <- cowplot::plot_grid(
  plotlist=get_plot_list(ll_auc, cols_rename, get_what="nmb", remove_axis=T, label_wrap_width=20) %>% keep_only_first_plot_strip(), 
  ncol=1,
